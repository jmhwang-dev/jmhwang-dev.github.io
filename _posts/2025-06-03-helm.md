...
> ⚠️ **Deprecated**: `helm search hub <keyword>`는 현재 사용되지 않음. <br>[Artifact Hub](https://artifacthub.io)를 사용 권장.
...
| 검증 방법 | 명령어 | 용도 |
|-----------|--------|------|
| Dry Run | `helm install <release-name> <chart> --dry-run --debug` | 실제 배포 없이 시뮬레이션 <br> 오류 사전 발견 |
